                ...
                <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                    <div className='pt-20 pb-16 text-center lg:pt-32'>
                        ...
                        <h1 className='font-display mx-auto max-w-4xl text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl dark:text-white'>
                            ...
                            <span className='relative whitespace-nowrap text-yellow-500 dark:text-yellow-500'>
                                <svg
                                    aria-hidden='true'
                                    viewBox='0 0 418 42'
                                    className='absolute top-2/3 left-0 h-[0.58em] w-full fill-yellow-500/70 dark:fill-yellow-500/40'
